...
app.get( '/', function( req, res ) {
    ...
    let authUrl =  oauth2.getAuthorizationUrl( { scope : 'id' } )  +
        // preserve the request params so they are handed back to us upon successful authentication
...
app.get( '/oauth2/callback', function( req, res ) {
    ...
    var state = JSON.parse( JSON.parse( decodeURIComponent( req.query.state ) ) );
    ...
    if ( redirectURL.hostname === requestURL.hostname ) {
        ...
        redirectURL.searchParams.append( 'code', encodeURIComponent(req.query.code) );
